...
task(
  ...
  .addOptionalParam('weth', 'The WETH contract address') /* 0x6969696969696969696969696969696969696969 */
  .addOptionalParam('noundersdao', 'The nounders DAO contract address') /* 0x5E7B4B48D1C36eed092fbDB3642370b733E57C52 */
  .addOptionalParam(
    'auctionTimeBuffer',
  ...
  .addOptionalParam('timelockDelay', 'The timelock delay (seconds)', 172800 /* 48h */, types.int)
  .addOptionalParam(
    'votingPeriod',
    'The voting period (blocks)',
    216000 /* 120h (2s blocks) */,
    types.int,
  )
  .addOptionalParam('votingDelay', 'The voting delay (blocks)', 27000 /* 15h (2s blocks) */, types.int)
  .addOptionalParam(
  ...
  .setAction(async (args, { run }) => {
    ...
    // Verify the contracts on Berascan
